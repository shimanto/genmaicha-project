/**
 * 玄米茶ちゃん 漫画 6ページを nano-banana-pro で生成
 *
 * 使い方:
...
キャラクター:
  - 主人公「玄米茶ちゃん」: 20代の若手日本人女性経営者。親しみやすいニックネーム。
    黒髪のショートボブ。素朴で明るい笑顔、芯の強い知的な目。
    生成り色のリネンの作業エプロンと、中の薄い藍染シャツ。手は荒れている(働き者)。
  - 母: 50代後半の日本人女性。白髪混じりの後ろで結んだ髪。穏やかな表情。
    紺の作業着 + 同じく作業エプロン。
場所: 宮城県の小さな焙煎工場。直火の焙煎釜、選別ザル、クラフト紙袋、和紙のような壁。
湯気・玄米のはじける粒・茶葉の匂いが画面から伝わるように。
ブランドマーク: 画面左下に小さく「玄米茶ちゃん」のロゴ(目立たせすぎず)。
...
const PAGES = [
  {
    ...
    title: '第1話 — 釜の前で',
    prompt: `${COMMON_STYLE}
シーン: 朝の焙煎工場。釜の前に立つ主人公 玄米茶ちゃん(20代女性)。
...
ブランドマーク左下: 玄米茶ちゃん`,
  },
  {
    ...
    title: '第2話 — 母とふたり',
    prompt: `${COMMON_STYLE}
シーン: 工場内の作業台で母娘(玄米茶ちゃんと母)が並んで焙煎玄米の選別をしている横顔。
...
ブランドマーク左下: 玄米茶ちゃん`,
  },
  {
    ...
    title: '第3話 — 卸と直販のあいだ',
    prompt: `${COMMON_STYLE}
シーン: 夜の事務机で、玄米茶ちゃんがノートPCに向かいながら帳簿(紙)も広げている。
画面には EC 管理画面、紙には「卸 / 直販」の図解メモ。
表情は思案。玄米茶の湯気が立ち上るマグカップ。
フキダシ(玄米茶ちゃん): 「卸先は止められない。でも、これだけじゃ未来が描けない。」
ブランドマーク左下: 玄米茶ちゃん`,
  },
  {
    file: 'page-04.png',
    title: '第4話 — 玄米茶という地図',
    prompt: `${COMMON_STYLE}
シーン: 工場の壁に世界地図を貼り、北米・欧州・アジアに色付きピンを刺している玄米茶ちゃん。
机にはタブレット、英語のEC画面。
表情は希望のある真剣さ。
...
ブランドマーク左下: 玄米茶ちゃん`,
  },
  {
    ...
    prompt: `${COMMON_STYLE}
シーン: 工場の作業台に置かれた、できたばかりの新パッケージ(クラフト紙袋に「玄米茶ちゃん」のロゴと焙煎玄米のイラスト)。
背景に祖父祖母の古い写真額。主人公が袋を両手で持ち上げ、母が後ろから穏やかに微笑んで見守る。
キャプション(画面下部): 「祖父祖母から受け継いだものを、世界へ繋ぎ直す。」
ブランドマーク左下: 玄米茶ちゃん`,
  },
  {
    file: 'page-06.png',
...
ダンボールには玄米茶ちゃんのロゴと「Made in Miyagi, Japan」の英語表記。
玄米茶ちゃんと母が並んで見送る。空には朝焼け (琥珀色のグラデーション)。
