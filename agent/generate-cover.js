/**
 * 玄米茶ちゃん — 漫画カバー画像生成 (LP のティーザーセクション用)
...
シーン: 宮城の小さな焙煎工場の前に立つ、20代の若手日本人女性経営者「玄米茶ちゃん」。
黒髪のショートボブ。生成り色のリネン作業エプロン、藍染シャツ。素朴で芯のある笑顔。
両手で焙煎玄米のクラフト紙袋(「玄米茶ちゃん」のロゴが見える)を抱えている。
背景: 古びた木造の工場、釜から立ち上る湯気、朝焼けの琥珀色の空。
画面右上に小さく「玄米茶ちゃん」、下端中央に英文「Roasted Brown Rice from Miyagi」。
