...
四隅にL字トリム、3mm塗り足しはグレー破線。`,
  },
  {
    ...
    title: '¥980 v3 — A5 二つ折り 表紙 (105×148mm 折り後) - 実商品4種構成',
...
構成: 4種テイスティング 折り畳みカバー。実工場で生産する2種(あられ・ポップライス)
を含む4構成。
内容(縦に積む):
  - 上部 1/3: 大きな漢字「焙」+ 小さく「HOU」(琥珀色、中央寄せ)
  - 中央 1/3: 筆書「テイスティング 4種セット」+ 「TASTING 4 KINDS」
  - 下部 1/3: 「¥980 (税込・送料込)」「朝の焙 + 夜の焙 + 玄米あられ + ポップライス 各5g」
...
3mm 塗り足し、L字トリム。`,
  },
  {
    ...
    title: '¥980 v3 — A5 二つ折り 内側 4ポケット展開 - 実商品4種',
...
構成: 実商品 4種の小袋を収納するポケット部分の説明レイアウト。
内容: 4列に等分(各 52×148mm 想定)、各列は 1 種ずつ:
  - 列1 (左端): 「朝の焙」筆書 + 琥珀色背景帯 + 「ASA-HOU 浅焙煎 5g / お湯200ml/30秒」
                 + 「(¥500 セットと同じ)」の小注釈
  - 列2: 「夜の焙」筆書 + 深茶背景帯 + 「YORU-HOU 深焙煎 5g / お湯200ml/60秒」
         + 「(¥500 セットと同じ)」の小注釈
  - 列3: 「玄米あられ」筆書 + 黄金色背景帯 + 「ARARE 炒り玄米 5g / そのまま噛んで楽しむ」
         + 米粒形のミニイラスト
  - 列4 (右端): 「ポップライス」筆書 + 白色背景+アクセント帯 + 「POP RICE 花 5g / 茶に浮かべて」
                 + ポップした玄米のミニイラスト
中央に縦の折り線(破線)、各列下部にダイカット線(切り込み)を破線で示す。
画面下部に細字: 「※ 塩玄米・抹茶混合は将来追加予定」
